...
import { IoLogoCss3, IoLogoFigma, IoLogoGithub, IoLogoGitlab, IoLogoHtml5, IoLogoJavascript, IoLogoLaravel, IoLogoLinkedin, IoLogoNodejs, IoLogoPython, IoLogoReact, IoLogoTux, IoLogoVue, IoMail } from 'react-icons/io5';
  ...
  stacks: [
    {
      ...
      technologies: [
        {
          icon: <IoLogoJavascript size={42} className="text-yellow-400"></IoLogoJavascript>,
          name: "Javascript"
        },
        {
        ...
        {
          icon: <IoLogoHtml5 size={42} className="text-orange-500"></IoLogoHtml5>,
          name: "HTML"
        },
        {
        ...
        {
          icon: <SiTailwindcss size={42} className="text-cyan-600"></SiTailwindcss>,
          name: "Tailwind"
        }
      ]
    },
    {
      ...
      technologies: [
        {
          icon: <IoLogoLaravel size={42} className="text-red-600"></IoLogoLaravel>,
          name: "Laravel"
        },
        {
        ...
        {
          icon: <IoLogoNodejs size={42} className="text-lime-500"></IoLogoNodejs>,
          name: "NodeJs"
        },
      ]
    },
    {
      ...
      technologies: [
        {
          icon: <IoLogoGithub size={42} className="text-slate-950"></IoLogoGithub>,
          name: "GitHub"
        },
        {
          icon: <IoLogoGitlab size={42} className="text-orange-500"></IoLogoGitlab>,
          name: "GitLab"
        }
      ]
    },
  ...
  experience: [
    {
      ...
      positions: [
        ...
        },
        {
          ...
          location: "presencial",
          attributions: [
            "Desenvolvimento de páginas web com VueJs",
          ]
        }
      ]
    }
